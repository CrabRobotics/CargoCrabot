...
#loading dock crane
    ...
    cargo_library.gyro_drive(200, 4, 0)
    robot.turn(90)
...
#backing up to the wall by helicopter
    robot.turn(75)
    cargo_library.bw_gyro_drive_until_t(300, 2700, 180)
    robot.stop()
...
#pushes train out
    ...
    #front_attachment_motor.run_until_stalled(150, then=Stop.BRAKE, duty_limit=None) 
#go back home
    cargo_library.bw_gyro_drive(600, 150, 180)
    front_attachment_motor.run_angle(150, 45, then=Stop.BRAKE)
    front_attachment_motor.run_until_stalled(150, then=Stop.BRAKE, duty_limit=None) 
    robot.turn(90)
    ...
    robot.turn(45)
    cargo_library.gyro_drive(1000, 560, 280)